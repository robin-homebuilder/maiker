      ...
      <section className='bg-accent py-[80px]'>
        <div className='max-w-[1250px] mx-auto'>
          ...
          <div className="flex gap-x-10">
            <div className="w-[820px] h-[528px] relative border border-[#C9C9C9]">
              <Image src="/Contact-Us.svg" fill={true} alt="Contact Us" className="object-cover"/>
            </div>
            <div className="w-fit">
              <div className="mb-[60px]">
                ...
                <div className="mt-5">
                  <div className="flex gap-x-1 items-center mb-4"> 
                    ...
                    <p className="text-dark">0404 481 771</p>
                  </div>
                  <div className="flex gap-x-1 items-center"> 
                    <span className="w-[25px] h-[25px] bg-dark rounded-full flex justify-center items-center">
                      <FaEnvelope color="#ffffff" size="12"/>
                    </span>
                    <p className="text-dark">admin@maiker.com.au</p>
                  </div>
                </div>
              </div>
              <h3 className="text-tertiary text-[18px] font-[800]">Business</h3>
              <div className="mt-5">
                <p className="mb-5 text-dark">Avecco Pty Ltd t/a Maiker Constructions</p>
                <p className="text-dark">ABN:36 123 456 789 QBCC: 123456</p>
              </div>
            </div>
          </div>
        </div>
