        ...
        <div className='max-w-[1250px] mx-auto'>
          ...
          <div className="flex gap-x-10">
            <div className="w-[820px] h-[528px] relative border border-[#C9C9C9]">
              <Image src={`${process.env.APP_S3_BUCKET}/assets/Contact-Us.png`} fill={true} alt="Contact Us" className="object-cover"/>
            </div>
            <div className="w-fit">
              <div className="mb-[60px]">
                ...
                <div className="mt-5">
                  <div className="flex gap-x-1 items-center mb-4"> 
                    ...
                    <p className="text-dark  text-[16px]">0404 481 771</p>
                  </div>
