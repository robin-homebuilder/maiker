    ...
    <>
      <section className='bg-accent py-[80px]'>
        <div className='max-w-[1250px] mx-auto'>
          <div className='px-5 sm:px-0'>
            ...
            <h2 className='text-tertiary font-[800] text-center mb-5'>Concept Home Design and Project Budget</h2>
          ...
          <div className='flex flex-wrap sm:flex-nowrap flex-col-reverse sm:flex-row gap-x-10'>
            <div className='w-full sm:w-1/2 px-5 sm:px-[50px]'>
              <h2 className='text-tertiary font-[700] text-center mb-10 text-[24px] sm:text-[21px]'>Design My Home</h2>
              <h2 className='text-warning italic font-[500] text-center mb-10'>A complete concept design and budget service.</h2>
              <p className='text-dark mb-10 text-center font-[500] px-10'>
            ...
            <div className='w-full sm:w-1/2 mb-5 sm:mb-0 pl-0 sm:pl-5'>
              <Image src={`${process.env.APP_S3_BUCKET}/assets/Quote-My-Plans.webp`} priority={true} width={500} height={426} alt="Design My Home"/>
            </div>
          </div>
        </div>
      </section>
      <section className="py-[60px] max-w-[1250px] mx-auto scroll-mt-[115px]" id="select-package">
        ...
        <div className='flex flex-wrap sm:flex-nowrap justify-start px-5 sm:px-0'>
          <div className='w-full h-full sm:w-[604px] sm:h-[450px] rounded-[20px] border border-primary overflow-hidden'>
            <span className='block bg-primary h-[26px] w-full'></span>
            <div className='p-5'>
              <h3 className='text-dark text-center text-[32px]'>Home Design and Budget</h3>
            ...
            <div className='bg-accent p-5'>
              <p className='text-warning text-center font-[600] italic'>Design your home within your budget</p>
