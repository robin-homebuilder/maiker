      ...
      <section className="h-[570px] overflow-hidden relative bg-pageHead">
        <div className="z-10 relative max-w-[1250px] mx-auto mt-5 flex">
          <div className="w-1/2 sm:w-[600px] px-5 sm:px-0">
            <h1 className="font-[800] mb-5 text-[30px] sm:text-[38px]">High quality home additions builder located in Brisbane</h1>
            <p className="font-[500] text-[18px] mb-5">Maiker Constructions designs and builds custom home additions projects in Brisbane. We specialize in timber construction and the modernization of any type of home.</p>
