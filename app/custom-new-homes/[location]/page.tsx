      ...
      <section className="h-full sm:h-[570px] overflow-hidden relative bg-pageHead">
        <div className="z-10 relative max-w-[1250px] mx-auto mt-[60px] sm:mt-5 flex pt-[230px] sm:pt-0">
          <div className="w-full sm:w-[600px] px-5 sm:px-0">
            <h1 className="font-[800] mb-5 text-[25px] sm:text-[38px]">High quality custom home builder located in <span className="capitalize">{formattedLocation}</span></h1>
            <p className="font-[500] text-[16px] sm:text-[18px] mb-5">Maiker Constructions is your one-stop solution for designing and constructing custom home projects in <span className="capitalize">{formattedLocation}</span>. Our expertise lies in timber construction, however, we are well-equipped and delighted to undertake any type of project. </p>
