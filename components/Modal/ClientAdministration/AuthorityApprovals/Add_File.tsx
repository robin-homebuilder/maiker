...
import { addAuthorityApprovalsFile } from '@/services/clientAdministration/authorityApprovalServices';
...
export default function Add_AuthorityApproval_File({ isOpen, closeModal, sectionID, clientID, refreshListSection } : ClientProps) {
  ...
  const [ formData, setFormData ] = useState<AuthorityApprovalProps>({
    section_name: "",
    name: "",
    file_name: "",
    amendment: ""
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await addAuthorityApprovalsFile({ data: formData, sectionID: sectionID, clientID: clientID});
