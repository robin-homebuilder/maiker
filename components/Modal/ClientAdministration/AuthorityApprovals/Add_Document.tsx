...
import { addAuthorityApprovals } from '@/services/clientAdministration/authorityApprovalServices';
...
export default function Add_AuthorityApproval_Document({ isOpen, closeModal, clientID, refreshList } : ClientProps) {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await addAuthorityApprovals({ data: formData, id: clientID});
