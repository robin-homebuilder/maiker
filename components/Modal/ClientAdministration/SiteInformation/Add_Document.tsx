...
import { addDocument } from '@/services/clientAdministration/siteInformation';
...
export default function Add_SiteInformation_Document({ isOpen, closeModal, refreshList, clientID } : ClientProps) {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await addDocument({ data: formData, id: clientID });
