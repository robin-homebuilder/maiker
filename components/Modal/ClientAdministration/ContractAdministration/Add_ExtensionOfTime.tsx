...
import { addExtensionTime } from '@/services/clientAdministration/contractAdministrationServices';
...
export default function Add_ExtensionOfTime({ isOpen, closeModal, refreshList, clientID } : ClientProps) {
  ...
  const [ formData, setFormData ] = useState<ExtensionTimeProps>({
    name: "",
    days_submitted: "",
    status: "",
    file_name: ""
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await addExtensionTime({ data: formData, clientID: clientID });
