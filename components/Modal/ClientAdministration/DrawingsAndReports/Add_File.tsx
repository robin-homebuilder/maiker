...
import { addDrawingsReportsFile } from '@/services/clientAdministration/drawingsReportsServices';
...
export default function Add_DrawingsAndReport_File({ isOpen, closeModal, sectionID, clientID, refreshListSection } : ClientProps) {
  ...
  const [ formData, setFormData ] = useState<DrawingsAndReportProps>({
    section_name: "",
    name: "",
    file_name: "",
    amendment: ""
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await addDrawingsReportsFile({ data: formData, sectionID: sectionID, clientID: clientID});
