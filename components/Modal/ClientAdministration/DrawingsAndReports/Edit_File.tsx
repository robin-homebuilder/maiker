...
import { updateDrawingsReportsFile } from '@/services/clientAdministration/drawingsReportsServices';
...
export default function Edit_DrawingsAndReport_File({ isOpen, closeModal, data, clientID, sectionID, refreshListSection, showDeleteModal } : ClientProps) {
  ...
  const [ formData, setFormData ] = useState<DrawingAndReportFileProps>({
    name: "",
    url: "",
    file_name: "",
    amendment: "",
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await updateDrawingsReportsFile({ data: formData, sectionID: sectionID, clientID: clientID});
