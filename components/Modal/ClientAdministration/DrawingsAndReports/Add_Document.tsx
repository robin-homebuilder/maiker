...
import { addDrawingsReports } from '@/services/clientAdministration/drawingsReportsServices';
...
export default function Add_DrawingsAndReport_Document({ isOpen, closeModal, clientID, refreshList } : ClientProps) {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await addDrawingsReports({ data: formData, id: clientID});
