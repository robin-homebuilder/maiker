...
import { updateComplianceOperationsFile } from '@/services/clientAdministration/complianceOperationServices';
...
export default function Edit_ComplianceOperation_File({ isOpen, closeModal, data, clientID, sectionID, refreshListSection, showDeleteModal } : ClientProps) {
  ...
  const [ formData, setFormData ] = useState<ComplianceOperationsFileProps>({
    name: "",
    url: "",
    file_name: "",
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await updateComplianceOperationsFile({ data: formData, sectionID: sectionID, clientID: clientID});
