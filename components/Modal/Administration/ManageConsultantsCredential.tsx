...
import { getConsultantCredentialByID, saveConsultantCredential } from '@/services/administration/consultantServices';
...
export default function Manage_Consultant_Credentials({ isOpen, closeModal, clientID } : ClientProps) {
  ...
  const fetchCredential = async (id: string) => {
    const data = await getConsultantCredentialByID(id);
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await saveConsultantCredential({ data: credentials });
