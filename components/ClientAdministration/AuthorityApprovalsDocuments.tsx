...
export default function AuthorityApprovals_Documents() {
  ...
  return (
    <>
      ...
      <Add_AuthorityApproval_Document isOpen={openAddModal} closeModal={() => setOpenAddModal(false)}/>
      <Edit_AuthorityApproval_Document isOpen={openEditModal} closeModal={() => setOpenEditModal(false)}/>
    </>
  )
}
