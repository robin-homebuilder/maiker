...
export default function DrawingAndReports_Documents() {
  ...
  return (
    <>
      ...
      <Add_DrawingsAndReport_Document isOpen={openAddModal} closeModal={() => setOpenAddModal(false)}/>
      <Edit_DrawingsAndReport_Document isOpen={openEditModal} closeModal={() => setOpenEditModal(false)}/>
    </>
  )
}
