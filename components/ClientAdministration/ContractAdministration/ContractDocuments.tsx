...
export default function Contract_Documents() {
  ...
  return (
    <>
      ...
      <Add_ContractAdministration_Document isOpen={openAddModal} closeModal={() => setOpenAddModal(false)}/>
      <Edit_ContractAdministration_Document isOpen={openEditModal} closeModal={() => setOpenEditModal(false)}/>
    </>
  )
}
