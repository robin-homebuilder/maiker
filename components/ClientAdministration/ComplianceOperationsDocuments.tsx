...
import Edit_ComplianceOperation_Document from "../Modal/ClientAdministration/ComplianceOperations/Edit_Document";

export default function ComplianceOperations_Documents() {
  ...
  return (
    <>
      <div className="mb-[25px]">
        ...
        <table className="w-full">
          <thead className="bg-[#F8F7F7] text-left text-[#7D7D7D] font-[600] border-b border-[#7D7D7D]">
            <tr>
              <th className="py-2 pl-5 w-6/12">Document Name</th>
              <th className="py-2 w-5/12 text-center">Date</th>
      ...
      <Add_ComplianceOperation_Document isOpen={openAddModal} closeModal={() => setOpenAddModal(false)}/>
      <Edit_ComplianceOperation_Document isOpen={openEditModal} closeModal={() => setOpenEditModal(false)}/>
    </>
  )
}
