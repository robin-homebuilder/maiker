        ...
        <div className="w-full flex flex-wrap sm:flex-nowrap justify-end gap-x-4 mt-10 gap-y-5 sm:gap-y-0">
          <div className="w-full sm:w-auto flex">
            <Link href="/" className="block w-1/2 sm:w-[120px]">
              <button 
                type="button" 
                className={`text-warning text-[16px] font-[600] h-[42px] w-full ${isSubmitting && "cursor-not-allowed"}`}
                disabled={isSubmitting}
              >Cancel</button>
            </Link>
            <button 
              type="button" 
              className={`text-warning border border-warning rounded-[20px] text-[16px] shadow-mainShadow font-[600] w-1/2 sm:w-[200px] h-[42px] ${isSubmitting && "cursor-not-allowed"}`} 
          ...
          <button 
            type="submit" 
            className={`text-white bg-warning rounded-[20px] text-[16px] shadow-mainShadow font-[600] w-full sm:w-[200px] h-[42px] flex justify-center items-center ${isSubmitting && "cursor-not-allowed"}`}
            disabled={isSubmitting}
          >
