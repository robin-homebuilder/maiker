    ...
    <footer className="relative overflow-hidden" id="footer">
      <div className="h-full sm:h-[482px] w-full relative">
        <div className="absolute h-full">
          ...
          <Image src={`${process.env.APP_S3_BUCKET}/assets/Maiker-Footer.webp`} width={4000} height={2000} priority={true} alt="Maiker House Project Footer Logo" className="object-cover h-full"/>
        </div>
